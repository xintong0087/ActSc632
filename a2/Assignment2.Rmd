...
Based on our results, the single tree is definitely not a good choice. Among the three other
methods, the pruned tree has the best overall prediction error and type-1 error, but bagging has
the lowest type-2 error. Given that bagging and random forest have much less variance, our
